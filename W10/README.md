...
![Screenshot](./project/users_fastapi/img/1.png)
![Screenshot ReDoc](./project/users_fastapi/img/2.png)

> 📎 [See project README for full details](./project/users_fastapi/README.md)